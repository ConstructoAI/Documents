...
- **Aucune écriture comptable.** Le coût réel d'une demande reste dans la table de maintenance ; rien n'est reporté vers la Comptabilité (Module 15).
...
### 5.1 Magasin / Inventaire (Module 10)
...
### 5.2 Logistique (Module 20) — deux systèmes de maintenance distincts
...
### 5.4 Bons de travail (Module 12) et Pointage (Module 13)
...
### 5.7 Documents et photos (Module 07 Dossiers)
...
**Manuels liés** :
- Module 10 (Magasin / Inventaire — décrément de stock à l'ajout de pièce, pas de re-crédit) — `10-operations-magasin.md`
- Module 12 (Bons de travail — travail humain, aucune intégration) — `12-operations-bons-de-travail.md`
- Module 13 (Pointage — heures de maintenance non propagées) — `13-operations-pointage.md`
- Module 15 (Comptabilité — aucun report automatique des coûts) — `15-operations-comptabilite.md`
- Module 20 (Logistique — maintenance de flotte distincte, protégée par rôle) — `20-terrain-logistique.md`
- Module 21 (Location — état `REPARATION` sans lien maintenance automatique) — `21-terrain-location.md`
