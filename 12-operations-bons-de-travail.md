...
- **Pas de saisie des heures de pointage ici.** Les heures réelles d'une opération se saisissent **à la main**. Le pointage des employés (table `time_entries`) se fait au **Module 13 Pointage** ; aucun mécanisme ne reporte automatiquement les pointages dans les heures réelles des opérations.
...
- **Le Kanban, le Gantt et le Calendrier ne sont pas dans cette page.** Ils affichent bien les bons de travail, mais appartiennent au **Module 03 Suivi**.
...
> Si la ligne est liée à un produit, le stock est **débité** (mouvement de sortie) et tracé dans les mouvements d'inventaire. Le serveur refuse d'ajouter une ligne à un bon **terminé ou annulé** (sauf super-administrateur). Le suivi des niveaux de stock et les alertes de seuil vivent dans le **Module 10 Magasin**.
...
| Module | Lien |
|--------|------|
| **Projets** (Module 09) | Un bon peut être rattaché à un projet ; le bouton « Générer la cédule » (page Projets) crée un bon de cédule ; la conversion d'un devis en projet génère aussi la cédule automatiquement. |
| **Magasin / Inventaire** (Module 10) | Les lignes de matériaux liées à un produit débitent le stock (sortie) et le recréditent à la suppression ou à l'annulation (entrée). Les mouvements et les alertes de seuil se consultent au Magasin. |
| **Suivi (Kanban / Gantt / Calendrier)** (Module 03) | Les mêmes bons de travail s'affichent dans ces vues. Le Kanban change leur statut (mais bloque l'annulation, à faire ici) ; le Gantt affiche les opérations en sous-tâches ; le Calendrier montre les échéances. |
| **Pointage** (Module 13) | Les employés pointent leurs heures ; ces pointages sont **liés** au bon mais **ne remontent pas** dans les heures réelles des opérations (saisie manuelle). |
| **Employés** (Module 11) | Les assignations et l'employé d'une opération sont choisis parmi les employés du tenant. |
| **Dossiers / Fiche 360** (Module 07) | Un bon rattaché à un projet lié à une opportunité est **auto-rattaché** au dossier correspondant. |
| **Configuration** (Module 28) | Le logo, les couleurs du document et la langue proviennent de la configuration de l'entreprise. |
| **Assistant IA** (Module 25) | L'assistant du module consomme les crédits IA prépayés du tenant. |
...
**Manuels liés** :
- Module 03 — Suivi & Gantt (Kanban, Gantt, Calendrier des bons de travail) — `03-suivi-gantt.md`
- Module 09 — Projets (génération de la cédule) — `09-ventes-projets.md`
- Module 10 — Magasin (mouvements de stock des matériaux) — `10-operations-magasin.md`
- Module 11 — Employés (assignations, employé d'opération) — `11-operations-employes.md`
- Module 13 — Pointage (heures des employés) — `13-operations-pointage.md`
- Module 25 — Assistant IA (crédits IA) — `25-communication-assistant-ia.md`
- Module 28 — Configuration (thème du document, langue) — `28-configuration.md`
