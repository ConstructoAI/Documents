# Module 14 — Comptabilité (grand livre, factures, paie, fonds de prévoyance)
...
| **Paie** (RRQ, RRQ2, RQAP, AE, FSS, CNESST, CCQ, périodes de paie, bulletins PDF) | Menu **Pointage** (`/pointage`), page **« Pointage & Paie »**, onglets **Paie** et **Paie CCQ** | Module 12 — Pointage et heures |
| **Feuillets fiscaux** (T4, RL-1, remise PD7A) | Menu **Pointage** (`/pointage`), onglet **Feuillets** | Module 12 — Pointage et heures |
| **Fonds de prévoyance** (Loi 16, études, projections sur 25 ans) | Volet **Immobilier / Terrain** (vitrine `/immo`, back-office promoteur) | Module 34 — Immobilier |
...
### 5.1 La paie et son lien avec la comptabilité (module 12 — Pointage)
...
### 5.2 Les feuillets fiscaux T4 / RL-1 / PD7A (module 12 — Pointage)
...
Toutes ces fonctions sont ouvertes à tout utilisateur authentifié du tenant (elles n'exigent pas le rôle comptable). Pour l'utiliser, reportez-vous au **Module 34 — Immobilier**.
...
### 5.5 Bons de commande (module 13 — Magasin)

Une facture fournisseur peut être **créée depuis un bon de commande** reçu. La **synchronisation comptable** (`sync-depenses`) génère des écritures d'achat pour les bons transmis, et des écritures de salaire à partir des heures d'employés. Voir le **Module 13 — Bons de commande**.
...
Elle est dans le menu **Pointage** (`/pointage`), onglets **Paie** et **Paie CCQ**. Voir le Module 12. La comptabilité ne fait que **recevoir** l'écriture de paie (en brouillon) et vous laisser la valider.
...
Dans le volet **Immobilier / Terrain** (Module 34), pas ici. Aucun onglet de `/comptabilite` n'y donne accès.
...
- **Malgré le titre, la paie, les feuillets et le fonds de prévoyance ne sont PAS ici** : la **paie** et les **feuillets** (T4, RL-1, PD7A) sont dans **Pointage** (Module 12) ; le **fonds de prévoyance** (Loi 16) est dans **Immobilier** (Module 34). La comptabilité **reçoit** l'écriture de paie (en brouillon) mais ne calcule aucun salaire.
...
**Manuels liés** :
- Module 12 — Pointage et heures (paie CCQ, feuillets T4 / RL-1 / PD7A) — `12-operations-pointage.md`
- Module 13 — Bons de commande (factures fournisseurs, comptabilisation des achats) — `13-operations-bons-de-commande.md`
- Module 07 — Soumissions (devis à l'origine des décomptes) — `07-ventes-soumissions.md`
- Module 08 — Projets (rattachement des factures et des travaux en cours) — `08-ventes-projets.md`
- Module 06 — Dossiers / Fiche 360 (ouverture directe d'une facture) — `06-ventes-dossiers.md`
- Module 34 — Immobilier (fonds de prévoyance, Loi 16) — `34-terrain-immobilier.md`
- Module 24 — Assistant IA (crédits IA du scan et de l'assistant comptable) — `24-communication-assistant-ia.md`
- Module 30 — Configuration (taxes, thème des documents, coordonnées bancaires) — `30-configuration.md`
