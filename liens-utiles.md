...
1. [Reglementation et licences](#1-reglementation-et-licences)
2. [Main d'oeuvre, formation et conventions](#2-main-doeuvre-formation-et-conventions)
3. [Sante et securite au travail](#3-sante-et-securite-au-travail)
4. [Fiscalite et obligations declaratives](#4-fiscalite-et-obligations-declaratives)
5. [Achats publics et appels d'offres](#5-achats-publics-et-appels-doffres)
6. [Subventions, programmes et financement](#6-subventions-programmes-et-financement)
7. [Codes, normes et standards techniques](#7-codes-normes-et-standards-techniques)
8. [Registres et verifications de probite](#8-registres-et-verifications-de-probite)
9. [Associations sectorielles et corporations de metiers](#9-associations-sectorielles-et-corporations-de-metiers)
...
## 2. Main d'oeuvre, formation et conventions
...
## 4. Fiscalite et obligations declaratives
...
## 5. Achats publics et appels d'offres
...
## 6. Subventions, programmes et financement
...
## 7. Codes, normes et standards techniques

| Norme | Pourquoi c'est utile | URL |
|---|---|---|
...
## 8. Registres et verifications de probite
...
## 9. Associations sectorielles et corporations de metiers
...
## 10. Ordres professionnels

| Ordre | Quand c'est requis | URL |
|---|---|---|
...
## 11. Lois et reglements de reference

| Texte | Pourquoi le connaitre | URL |
|---|---|---|
| **Loi sur le batiment** (B-1.1) | Cadre des licences RBQ et obligations entrepreneurs | https://www.legisquebec.gouv.qc.ca/fr/document/lc/B-1.1 |
| **Loi sur la sante et la securite du travail (LSST)** | Obligations de prevention, comites de chantier, droit de refus | https://www.legisquebec.gouv.qc.ca/fr/document/lc/S-2.1 |
| **Loi sur les accidents du travail et les maladies professionnelles (LATMP)** | Indemnisation, cotisations, retour au travail | https://www.legisquebec.gouv.qc.ca/fr/document/lc/A-3.001 |
| **Loi R-20** — Loi sur les relations du travail dans la construction | Cadre des conventions, juridiction CCQ, secteurs assujettis | https://www.legisquebec.gouv.qc.ca/fr/document/lc/R-20 |
| **Loi sur les contrats des organismes publics (LCOP)** | Regles d'octroi de contrats publics, seuils, exigences AMP | https://www.legisquebec.gouv.qc.ca/fr/document/lc/C-65.1 |
| **Loi sur la qualite de l'environnement (LQE)** | Certificats d'autorisation, eaux usees, sols contamines | https://www.legisquebec.gouv.qc.ca/fr/document/lc/Q-2 |

---

## 12. Veille, medias et outils sectoriels
...
## Tableau "10 essentiels en signets"

Si vous ne devez en garder que dix au quotidien :
...
Cette page est independante de la constante `LIENS_UTILES` du frontend (`ERP_REACT/frontend/src/pages/WebPage.tsx`) — le frontend conserve une version courte (8 liens) pour ne pas surcharger l'UI, alors que cette page sert de reference exhaustive.
