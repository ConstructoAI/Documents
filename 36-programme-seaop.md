# Module 36 — SEAOP (appels d'offres publics Québec)
...
- **Assistant IA (Claude).** L'assistant de SEAOP est **propre à SEAOP** ; ce n'est pas l'Assistant IA de l'ERP (module 24). Il ne lit que les données SEAOP, avec un périmètre imposé par le serveur.
...
*Manuels liés :* `24-communication-assistant-ia.md` (l'Assistant IA de l'ERP, à ne pas confondre avec celui de SEAOP), `07-ventes-soumissions.md` (les soumissions internes de l'ERP), `35-programme-portail-b2b.md` (l'autre application autonome servie par l'ERP), `16-terrain-conformite.md` (RBQ, CNESST, cautionnement — contexte de conformité québécois).

*Manuel ERP Constructo AI — Module 36 « SEAOP (appels d'offres publics Québec) » — v1.0 vérifié — 2026-07.*
