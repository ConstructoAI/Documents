# Module 26 — Construction Calculators
...
**Related manuals**:
- Module 08 — Quotes (copy or receive quantities) — `08-ventes-soumissions.md`
- Module 10 — Store / Inventory (real supplier prices) — `10-operations-magasin.md`
- Module 13 — Time Tracking (real payroll vs indicative calculation) — `13-operations-pointage.md`
- Module 14 — Purchase Orders (buying materials) — `14-operations-bons-de-commande.md`
- Module 25 — AI Assistant (prepaid AI credits) — `25-communication-assistant-ia.md`
- Module 30 — Takeoff (BOM assemblies, quantity takeoff) — `30-metre-pdf.md`
- Module 31 — 3D Modeling / CAD — `31-outils-dao-modelisation.md`
