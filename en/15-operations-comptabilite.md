# Module 15 — Accounting (general ledger, invoices, payroll, contingency fund)
...
| **Payroll** (RRQ, RRQ2, RQAP, EI, FSS, CNESST, CCQ, pay periods, PDF pay stubs) | **Time Tracking** menu (`/pointage`), the **"Time Tracking & Payroll"** page, **Payroll** and **CCQ Payroll** tabs | Module 13 — Time Tracking and Hours |
| **Tax slips** (T4, RL-1, PD7A remittance) | **Time Tracking** menu (`/pointage`), **Slips** tab | Module 13 — Time Tracking and Hours |
| **Contingency fund** (Law 16, studies, 25-year projections) | **Real Estate / Land** area (`/immo` storefront, developer back-office) | Module 19 — Real Estate |
...
### 5.1 Payroll and its link with accounting (Module 13 — Time Tracking)
...
### 5.2 The T4 / RL-1 / PD7A tax slips (Module 13 — Time Tracking)
...
All these functions are open to any authenticated user of the tenant (they do not require the accountant role). To use it, refer to **Module 19 — Real Estate**.
...
### 5.5 Purchase orders (Module 14 — Store)

A supplier invoice can be **created from a received purchase order**. The **accounting synchronization** (`sync-depenses`) generates purchase entries for transmitted orders, and wage entries from employee hours. See **Module 14 — Purchase Orders**.
...
It is in the **Time Tracking** menu (`/pointage`), **Payroll** and **CCQ Payroll** tabs. See Module 13. Accounting only **receives** the payroll entry (as a draft) and lets you validate it.
...
In the **Real Estate / Land** area (Module 19), not here. No tab of `/comptabilite` gives access to it.
...
- **Despite the title, payroll, the slips and the contingency fund are NOT here**: **payroll** and the **slips** (T4, RL-1, PD7A) are in **Time Tracking** (Module 13); the **contingency fund** (Law 16) is in **Real Estate** (Module 19). Accounting **receives** the payroll entry (as a draft) but computes no salary.
...
**Related manuals**:
- Module 13 — Time Tracking and Hours (CCQ payroll, T4 / RL-1 / PD7A slips) — `13-operations-pointage.md`
- Module 14 — Purchase Orders (supplier invoices, posting of purchases) — `14-operations-bons-de-commande.md`
- Module 08 — Quotes (the quotes that originate progress claims) — `08-ventes-soumissions.md`
- Module 09 — Projects (linking of invoices and work in progress) — `09-ventes-projets.md`
- Module 07 — Case Files / 360 View (direct opening of an invoice) — `07-ventes-dossiers.md`
- Module 19 — Real Estate (contingency fund, Law 16) — `19-terrain-immobilier.md`
- Module 25 — AI Assistant (AI credits for the scan and the accounting assistant) — `25-communication-assistant-ia.md`
- Module 28 — Configuration (taxes, document theme, banking details) — `28-configuration.md`
