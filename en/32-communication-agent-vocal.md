# Module 32 — AI Voice Agent (virtual receptionist)
...
*Related manuals:* `06-gestion-crm-opportunites.md` (opportunities and B.A.T.), `08-ventes-soumissions.md` and `09-ventes-projets.md` (documents read in Mode B), `12-operations-bons-de-travail.md`, `15-operations-comptabilite.md` (invoices), `23-communication-emails.md` (email relay), `24-communication-messagerie.md`, `28-configuration.md` (subscription and consultation mode).
