...
**Related manuals**:
- Module 10 (Employees — author name resolution) — `10-operations-employes.md`
- Module 21 (Emails — distinct from internal messaging) — `21-communication-emails.md`
- Module 24 (AI Assistant — shared credit engine) — `24-communication-assistant-ia.md`
- Module 30 (Configuration — shared `notifications` table, top-bar bell) — `30-configuration.md`
