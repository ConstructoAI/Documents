...
- **No payroll or CCQ contributions**: hours serve as a renewal reference, not as a basis for wage calculation (see Module 13 Time Tracking and Module 11 Employees).
...
1. Beforehand, create the employee's record in **Module 11 (Employees)**: the card attaches to an existing employee.
...
### 5.1 Integration with Module 11 (Employees)
...
- CCQ hours are not fed from **Module 13 (Time Tracking)**: the "accumulated hours" field is entered by hand.
- The phase compliance indicators in **Module 19 (Real Estate)** are separate and unrelated to the licenses recorded here.

### 5.3 Integration with Accounting and Grants

- **No automatic accounting entry.** Bonds and insurance are informational: they are not accounting liabilities or assets. To be recorded manually in **Module 15 (Accounting)**.
- The AI's training recommendations may mention subsidized programs, but with **no** automatic link to **Module 18 (Grants)**.

### 5.4 AI integration and credits

- The 7 AI tools go through the tenant's **prepaid credits** control (the same credits as the ERP's other AI features, see **Module 25**).
...
**Related manuals**:
- Module 11 (Employees — create the employee record before the CCQ card) — `11-operations-employes.md`
- Module 13 (Time Tracking — hours are not synchronized here automatically) — `13-operations-pointage.md`
- Module 15 (Accounting — manual recording of bonds and insurance) — `15-operations-comptabilite.md`
- Module 18 (Grants — funded training programs) — `18-terrain-subventions.md`
- Module 19 (Real Estate — separate phase compliance indicators) — `19-terrain-immobilier.md`
- Module 25 (AI Assistant — AI credits and the general operation of the AI) — `25-communication-assistant-ia.md`
- Module 28 (Configuration — tenant and access management) — `28-configuration.md`
