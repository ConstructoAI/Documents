...
**Related manuals**:
- Module 09 — Construction Projects (geographic reference of the site, no technical link) — `09-ventes-projets.md`
- Module 03 — Tracking / Gantt (construction phases, no weather integration) — `03-suivi-gantt.md`
- Module 12 — Work Orders (to suspend manually on a critical alert) — `12-operations-bons-de-travail.md`
- Module 25 — AI Assistant (credit wallet shared with the weather assistant) — `25-communication-assistant-ia.md`
