...
- **Separate module**: the AI Assistant has its own server (`routers/ai.py`) and its own AI-credit billing — it is **not** part of the Help and resources section. See `25-communication-assistant-ia.md`.
...
The AI Assistant is the only **in-app assisted** help in the ERP, but it is not part of this section: it is a standalone module (server `routers/ai.py`), reachable via the sparkles button in the top bar (`TopBar.tsx:312-320`). It consumes **AI credits** and can consult your data. Details: `25-communication-assistant-ia.md`.
...
**Related manuals**:
- AI Assistant (in-app assisted help, AI credits) — `25-communication-assistant-ia.md`
- Voice agent (telephony, voice chatbot) — `32-communication-agent-vocal.md`
- Configuration (subscription, payment method, preferences) — `28-configuration.md`
- Web (real-time search + Quebec useful links) — `27-outils-web.md`
