# Module 24 — AI Assistant (Claude, expert profiles)
...
**Related manuals**:
- Module 07 (Sales — Quotes / **AI Estimation**) — `07-ventes-soumissions.md`
- Module 04 (Contact management — imported clients) — `04-gestion-contacts.md`
- Module 34 (Field — Real Estate, AI mini-assistant) — `34-terrain-immobilier.md`
- Module 22 (Communication — Messaging, AI mini-assistant) — `22-communication-messagerie.md`
- Module 30 (Configuration — AI credits, Stripe) — `30-configuration.md`
- Module 32 (PDF Takeoff — expert profiles) — `32-metre-pdf.md`
