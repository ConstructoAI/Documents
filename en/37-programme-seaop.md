# Module 37 — SEAOP (Quebec public tenders)
...
- **AI Assistant (Claude).** SEAOP's assistant is **specific to SEAOP**; it is not the ERP's AI Assistant (module 25). It reads only SEAOP data, with a scope enforced by the server.
...
*Related manuals:* `25-communication-assistant-ia.md` (the ERP's AI Assistant, not to be confused with SEAOP's), `08-ventes-soumissions.md` (the ERP's internal quotes), `36-programme-portail-b2b.md` (the other standalone application served by the ERP), `17-terrain-conformite.md` (RBQ, CNESST, bonding — Quebec compliance context).

*Constructo AI ERP Manual — Module 37 "SEAOP (Quebec public tenders)" — v1.0 verified — 2026-07.*
