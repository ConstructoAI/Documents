# Module 10 — Store (products, inventory, purchasing)
...
**Related manuals**:
- Module 12 — Work Orders (material issues) — `12-operations-bons-de-travail.md`
- Module 14 — Purchase Orders / Purchasing (complementary view) — `14-operations-bons-de-commande.md`
- Module 15 — Accounting (supplier invoices, general ledger) — `15-operations-comptabilite.md`
- Module 09 — Projects (association of POs and movements) — `09-ventes-projets.md`
