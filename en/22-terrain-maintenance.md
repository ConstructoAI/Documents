# Module 22 — Maintenance (preventive, corrective, predictive)
...
- **No accounting entry.** A request's actual cost stays in the maintenance table; nothing is posted to Accounting (Module 15).
...
### 5.2 Logistics (Module 20) — two distinct maintenance systems
...
### 5.4 Work Orders (Module 12) and Time Tracking (Module 13)
...
### 5.7 Documents and photos (Module 07 Dossiers)
...
**Related manuals**:
- Module 10 (Store / Inventory — stock decrement on part add, no re-credit) — `10-operations-magasin.md`
- Module 12 (Work Orders — human work, no integration) — `12-operations-bons-de-travail.md`
- Module 13 (Time Tracking — maintenance hours not propagated) — `13-operations-pointage.md`
- Module 15 (Accounting — no automatic cost posting) — `15-operations-comptabilite.md`
- Module 20 (Logistics — separate fleet maintenance, role-protected) — `20-terrain-logistique.md`
- Module 21 (Rental — `REPARATION` condition with no automatic maintenance link) — `21-terrain-location.md`
