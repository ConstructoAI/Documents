# Module 17 — Grants and Government Assistance
...
- **No automatic accounting entry.** A disbursement (`statut = VERSEE`) is **not** posted to the general ledger. You must create the entry manually in Module 14 (Accounting).
...
> Unlike Module 16 (Compliance), which accepts only PDF and images, this module also accepts Word, Excel, text and CSV documents — handy for attaching a business plan, financial projections or a spreadsheet.
...
When an application moves to `VERSEE`: go to **Module 14 (Accounting)** → Journal → **New entry**. Record the receipt of funds (debit cash, credit a grant-revenue account). Carry the application's **internal reference** into the entry's description to ease reconciliation.
...
### 5.1 Integration with Accounting (Module 14)
...
### 5.2 Integration with Compliance (Module 16)
...
- Several programs (SCHL, Maisons Canada, Investissement Québec) **require** a valid RBQ license and up-to-date tax attestations. Check them in Module 16 **before** bidding, and attach a copy in the application's Documents section.
...
### 5.4 Integration with Documents (Module 06)
...
### 5.5 AI and credits integration (Module 24)

- The 5 AI tools go through the **same prepaid-credit mechanism** as the ERP's other AI features (see Module 24).
...
**Related manuals**:
- Module 06 (Documents — separate document management) — `06-ventes-dossiers.md`
- Module 08 (Projects — optional project ↔ application link) — `08-ventes-projets.md`
- Module 14 (Accounting — manual recording of disbursements) — `14-operations-comptabilite.md`
- Module 16 (RBQ/CCQ Compliance — licenses and attestations required by some programs) — `16-terrain-conformite.md`
- Module 34 (Real Estate — SCHL affordable-housing programs) — `34-terrain-immobilier.md`
- Module 24 (AI Assistant — AI credits and general AI operation) — `24-communication-assistant-ia.md`
- Module 30 (Configuration — tenant, role and access management) — `30-configuration.md`
