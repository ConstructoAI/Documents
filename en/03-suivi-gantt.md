# Module 03 — Tracking (Kanban, Gantt, Calendar)
...
|---|---|---|
| **CRM / Opportunities** | "Sales" board and Gantt source; reordering and status change of opportunities | [06-gestion-crm-opportunites.md](./06-gestion-crm-opportunites.md) |
| **Quotes** | "Quotes" board and Gantt source; Gantt dates | [08-ventes-soumissions.md](./08-ventes-soumissions.md) |
| **Projects** | "Projects" board and Gantt source (with phases); assignments and dates | [09-ventes-projets.md](./09-ventes-projets.md) |
| **Work Orders** | "Work Orders" board and source; operations as subtasks; assignments; state machine | [12-operations-bons-de-travail.md](./12-operations-bons-de-travail.md) |
| **Purchase orders (Purchases)** | "Purchases" board and source; delivery dates; assignments | [14-operations-bons-de-commande.md](./14-operations-bons-de-commande.md) |
| **Accounting (Invoices)** | "Invoices" board, read-only | [15-operations-comptabilite.md](./15-operations-comptabilite.md) |
| **Store (Inventory)** | Suppliers offered for operation assignment; purchase receiving | [10-operations-magasin.md](./10-operations-magasin.md) |
| **Employees** | Employee list for assignments | [11-operations-employes.md](./11-operations-employes.md) |
...
*Constructo ERP Manual — Module 03 Tracking (Kanban, Gantt, Calendar) — v3.0 verified against the source code — 2026-07-07*
...
**Related manuals**:
- Module 06 — CRM / Opportunities: [06-gestion-crm-opportunites.md](./06-gestion-crm-opportunites.md)
- Module 08 — Quotes: [08-ventes-soumissions.md](./08-ventes-soumissions.md)
- Module 09 — Projects: [09-ventes-projets.md](./09-ventes-projets.md)
- Module 12 — Work Orders: [12-operations-bons-de-travail.md](./12-operations-bons-de-travail.md)
- Module 14 — Purchase Orders: [14-operations-bons-de-commande.md](./14-operations-bons-de-commande.md)
- Module 15 — Accounting (Invoices): [15-operations-comptabilite.md](./15-operations-comptabilite.md)
- Module 25 — AI Assistant: [25-communication-assistant-ia.md](./25-communication-assistant-ia.md)
