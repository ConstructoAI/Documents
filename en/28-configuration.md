# Module 28 — Configuration (company, users, subscription)
...
**Related manuals**:
- Module 11 (Employees — records linked to user accounts) — `11-operations-employes.md`
- Module 13 (Time Tracking and Payroll — T4/RL-1/PD7A slips fed by the employer information) — `13-operations-pointage.md`
- Module 15 (Accounting — taxes, holdback, country/currency, fiscal year) — `15-operations-comptabilite.md`
- Module 25 (AI Assistant — AI credits recharged here) — `25-communication-assistant-ia.md`
