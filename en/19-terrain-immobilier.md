# Module 19 — Real Estate (developer and public storefront)
...
**Related manuals**:
- Module 07 (Dossiers — to host actual files) — `07-ventes-dossiers.md`
- Module 09 (Projects — distinct from real estate projects) — `09-ventes-projets.md`
- Module 15 (Accounting — manual entries) — `15-operations-comptabilite.md`
- Module 25 (AI Assistant — shared AI credits) — `25-communication-assistant-ia.md`
- Module 28 (Configuration — subscription and consultation mode) — `28-configuration.md`
