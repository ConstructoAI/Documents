# Module 38 — Mobile Time Clock (employee time-tracking PWA)
...
| 3D files in a render | *(not applicable: see module 27)* |
...
*Related manuals:* `12-operations-pointage.md` (time tracking on the ERP side, which shares `time_entries`), `11-operations-bons-de-travail.md` (the work orders you clock against), `06-ventes-dossiers.md` (the dossiers / 360° Record), `09-operations-magasin.md` and `13-operations-bons-de-commande.md` (the inventory, receiving and purchase orders), `14-operations-comptabilite.md` (invoices and payments), `24-communication-assistant-ia.md` (the AI assistant), `22-communication-messagerie.md` (messaging), `15-terrain-meteo-chantier.md` (weather), `28-outils-calculateurs.md` (the calculator).

*Constructo AI ERP Manual — Module 38 "Mobile Time Clock (employee time-tracking PWA)" — v1.0 verified — 2026-07.*
