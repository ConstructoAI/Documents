# Module 05 — Contacts (individuals)
...
**Related manuals**:
- Manual 04 — Companies (clients and suppliers): `04-gestion-entreprises.md`
- Manual 06 — CRM and opportunities (interactions, pipeline): `06-gestion-crm-opportunites.md`
- Manual 08 — Quotes: `08-ventes-soumissions.md`
- Manual 09 — Projects: `09-ventes-projets.md`
- Manual 23 — Emails (automatic matching by email): `23-communication-emails.md`
- Manual 25 — AI Assistant (overview): `25-communication-assistant-ia.md`
- Manual 28 — Configuration (user accounts, categories): `28-configuration.md`

---

*Constructo AI ERP Manual — Module 05 Contacts — v3.0 verified against the source code — July 2026*
