# Module 26 — Calculateurs de construction
...
**Manuels liés** :
- Module 8 — Soumissions (recopier ou recevoir les quantités) — `08-ventes-soumissions.md`
- Module 10 — Magasin / Inventaire (prix fournisseurs réels) — `10-operations-magasin.md`
- Module 13 — Pointage (paie réelle vs calcul indicatif) — `13-operations-pointage.md`
- Module 14 — Bons de commande (achat des matériaux) — `14-operations-bons-de-commande.md`
- Module 25 — Assistant IA (crédits IA prépayés) — `25-communication-assistant-ia.md`
- Module 30 — Métré (assemblages BOM, prise de quantités) — `30-metre-pdf.md`
- Module 31 — Modélisation 3D / DAO — `31-outils-dao-modelisation.md`
