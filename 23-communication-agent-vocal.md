# Module 23 — Agent vocal IA (standardiste virtuelle)
...
*Manuels liés :* `05-gestion-crm-opportunites.md` (opportunités et B.A.T.), `07-ventes-soumissions.md` et `08-ventes-projets.md` (documents lus en Mode B), `11-operations-bons-de-travail.md`, `14-operations-comptabilite.md` (factures), `21-communication-emails.md` (relais courriel), `22-communication-messagerie.md`, `30-configuration.md` (abonnement et mode consultation).
