...
**Manuels liés** :
- Module Projets (référence géographique du chantier, sans lien technique) — `01-projets.md`
- Module Suivi / Gantt (phases de construction, sans intégration météo) — `02-suivi-gantt.md`
- Module Bons de Travail (à suspendre manuellement en cas d'alerte critique) — `05-bons-de-travail.md`
- Module IA (portefeuille de crédits partagé avec l'assistant météo) — `12-ia.md`
