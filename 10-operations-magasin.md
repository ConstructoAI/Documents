# Module 10 — Magasin (produits, inventaire, achats)
...
**Manuels liés** :
- Module 12 — Bons de Travail (sorties de matériel) — `12-operations-bons-de-travail.md`
- Module 14 — Bons de Commande / Achats (vue complémentaire) — `14-operations-bons-de-commande.md`
- Module 15 — Comptabilité (factures fournisseurs, grand livre) — `15-operations-comptabilite.md`
- Module 09 — Projets (association des BC et mouvements) — `09-ventes-projets.md`
- Module 07 — Dossiers / Fiche 360 (ouverture directe d'un BC) — `07-ventes-dossiers.md`
