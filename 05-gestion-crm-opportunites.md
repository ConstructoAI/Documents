# Module 05 — Ventes (CRM, opportunités, pipeline, B2B back-office)
...
À la création, le système génère le numéro `OPP-00001`, ainsi qu'un **dossier client** `DOS-OPP-…` de type CLIENT (au mieux, voir module 06).
...
| **05 — Contacts** | Le champ « Client (Personne) » d'une opportunité pointe vers un contact. Gestion des contacts : module 04. |
...
*Manuel ERP Constructo AI — Module 05 Ventes (CRM, opportunités, pipeline, B2B back-office) — v3.0 vérifié — 2026-07*
