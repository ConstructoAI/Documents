# Module 39 — Pointeur mobile (PWA de pointage employés)
...
| Fichiers 3D dans un rendu | *(non concerné : voir module 34)* |
...
*Manuels liés :* `13-operations-pointage.md` (le pointage côté ERP, qui partage `time_entries`), `12-operations-bons-de-travail.md` (les bons de travail pointés), `07-ventes-dossiers.md` (les dossiers / Fiche 360), `10-operations-magasin.md` et `14-operations-bons-de-commande.md` (l'inventaire, la réception et les bons de commande), `15-operations-comptabilite.md` (les factures et paiements), `25-communication-assistant-ia.md` (l'assistant IA), `24-communication-messagerie.md` (la messagerie), `16-terrain-meteo-chantier.md` (la météo), `26-outils-calculateurs.md` (la calculatrice).

*Manuel ERP Constructo AI — Module 39 « Pointeur mobile (PWA de pointage employés) » — v1.0 vérifié — 2026-07.*
