# Module 34 — Immobilier (promoteur et vitrine publique)
...
**Manuels liés** :
- Module 06 (Dossiers — pour héberger de vrais fichiers) — `06-ventes-dossiers.md`
- Module 08 (Projets — distincts des projets immobiliers) — `08-ventes-projets.md`
- Module 14 (Comptabilité — écritures manuelles) — `14-operations-comptabilite.md`
- Module 24 (Assistant IA — crédits IA partagés) — `24-communication-assistant-ia.md`
- Module 30 (Configuration — abonnement et mode consultation) — `30-configuration.md`
