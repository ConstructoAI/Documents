# Module 24 — Assistant IA (Claude, profils experts)
...
**Manuels liés** :
- Module 07 (Ventes — Soumissions / **Estimation IA**) — `07-ventes-soumissions.md`
- Module 04 (Gestion des contacts — clients importés) — `04-gestion-contacts.md`
- Module 34 (Terrain — Immobilier, mini-assistant IA) — `34-terrain-immobilier.md`
- Module 22 (Communication — Messagerie, mini-assistant IA) — `22-communication-messagerie.md`
- Module 30 (Configuration — crédits IA, Stripe) — `30-configuration.md`
- Module 32 (Métré PDF — profils experts) — `32-metre-pdf.md`
