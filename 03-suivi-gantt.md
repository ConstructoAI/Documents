# Module 03 — Suivi (Kanban, Gantt, Calendrier)
...
|---|---|---|
| **CRM / Opportunités** | Tableau et source Gantt « Ventes » ; réordonnancement et changement de statut des opportunités | [06-gestion-crm-opportunites.md](./06-gestion-crm-opportunites.md) |
| **Soumissions (Devis)** | Tableau et source Gantt « Soumissions » ; dates du Gantt | [08-ventes-soumissions.md](./08-ventes-soumissions.md) |
| **Projets** | Tableau et source Gantt « Projets » (avec phases) ; assignations et dates | [09-ventes-projets.md](./09-ventes-projets.md) |
| **Bons de travail** | Tableau et source « BT » ; opérations en sous-tâches ; assignations ; machine à états | [12-operations-bons-de-travail.md](./12-operations-bons-de-travail.md) |
| **Bons de commande (Achats)** | Tableau et source « Achats » ; dates de livraison ; assignations | [14-operations-bons-de-commande.md](./14-operations-bons-de-commande.md) |
| **Comptabilité (Factures)** | Tableau « Factures » en lecture seule | [15-operations-comptabilite.md](./15-operations-comptabilite.md) |
| **Magasin (Inventaire)** | Fournisseurs proposés à l'assignation des opérations ; réception des achats | [10-operations-magasin.md](./10-operations-magasin.md) |
| **Employés** | Liste des employés pour les assignations | [11-operations-employes.md](./11-operations-employes.md) |
...
*Manuel ERP Constructo — Module 03 Suivi (Kanban, Gantt, Calendrier) — v3.0 vérifié par rapport au code source — 2026-07-07*
...
**Manuels liés** :
- Module 06 — CRM / Opportunités : [06-gestion-crm-opportunites.md](./06-gestion-crm-opportunites.md)
- Module 08 — Soumissions (Devis) : [08-ventes-soumissions.md](./08-ventes-soumissions.md)
- Module 09 — Projets : [09-ventes-projets.md](./09-ventes-projets.md)
- Module 12 — Bons de Travail : [12-operations-bons-de-travail.md](./12-operations-bons-de-travail.md)
- Module 14 — Bons de Commande : [14-operations-bons-de-commande.md](./14-operations-bons-de-commande.md)
- Module 15 — Comptabilité (Factures) : [15-operations-comptabilite.md](./15-operations-comptabilite.md)
- Module 25 — Assistant IA : [25-communication-assistant-ia.md](./25-communication-assistant-ia.md)
