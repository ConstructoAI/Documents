...
**Manuels liés** :
- Manuel 04 — Entreprises (clients et fournisseurs) : `04-gestion-entreprises.md`
- Manuel 06 — CRM et opportunités (interactions, pipeline) : `06-gestion-crm-opportunites.md`
- Manuel 08 — Soumissions (devis) : `08-ventes-soumissions.md`
- Manuel 09 — Projets : `09-ventes-projets.md`
- Manuel 23 — Courriels (rapprochement automatique par courriel) : `23-communication-emails.md`
- Manuel 25 — Assistant IA (vue d'ensemble) : `25-communication-assistant-ia.md`
- Manuel 28 — Configuration (comptes utilisateurs, catégories) : `28-configuration.md`

---

*Manuel ERP Constructo AI — Module 05 Contacts — v3.0 vérifié contre le code source — juillet 2026*
