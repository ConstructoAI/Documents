# Module 21 — Location d'équipements et prêts de main-d'œuvre
...
### 5.3 Comptabilité et Factures (Module 15)
...
### 5.4 Magasin / Inventaire (Module 10)
...
### 5.6 Logistique (Module 20) et Maintenance (Module 22) — chevauchement de périmètre
...
- **Maintenance (Module 22)** couvre l'entretien des équipements. L'état `REPARATION` d'un équipement de location est un simple indicateur : **aucun lien automatique** vers un bon de maintenance. Suivi manuel (passer l'équipement en `REPARATION`, puis le remettre en état après réparation).

### 5.7 Crédits IA (Module 25)
...
**Manuels liés** :
- Module 04 (Entreprises / Contacts — clients de contrats, liens non câblés à l'écran) — `04-gestion-entreprises.md`
- Module 06 (CRM — opportunités) — `06-gestion-crm-opportunites.md`
- Module 09 (Projets — référence `project_id` non câblée) — `09-ventes-projets.md`
- Module 10 (Magasin / Inventaire — distinct, pas de lien de stock) — `10-operations-magasin.md`
- Module 11 (Employés / RH — source des employés prêtés) — `11-operations-employes.md`
- Module 13 (Pointage — heures de prêt non propagées) — `13-operations-pointage.md`
- Module 15 (Comptabilité / Factures — report manuel, pas de facture auto) — `15-operations-comptabilite.md`
- Module 20 (Logistique — équipements internes, chevauchement de périmètre) — `20-terrain-logistique.md`
- Module 22 (Maintenance — état `REPARATION` suivi manuel) — `22-terrain-maintenance.md`
