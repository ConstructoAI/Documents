# Module 03 — Entreprises (clients et fournisseurs)
...
**Manuels liés** :
- Manuel 05 — Contacts (personnes physiques) : `04-gestion-contacts.md`
- Manuel 06 — CRM et opportunités : `05-gestion-crm-opportunites.md`
- Manuel 08 — Soumissions : `07-ventes-soumissions.md`
- Manuel 09 — Projets : `08-ventes-projets.md`
- Manuel 14 — Bons de commande (fournisseurs) : `13-operations-bons-de-commande.md`
- Manuel 15 — Comptabilité et factures : `14-operations-comptabilite.md`
- Manuel 17 — Conformité (RBQ / CCQ / CNESST) : `16-terrain-conformite.md`
- Manuel 25 — Assistant IA (vue d'ensemble) : `24-communication-assistant-ia.md`
- Manuel 28 — Configuration (catégories de fournisseurs, QuickBooks) : `30-configuration.md`
