...
**Manuels liés** :
- Module 10 (Employés — résolution des noms d'auteurs) — `10-operations-employes.md`
- Module 21 (Emails — distinct de la messagerie interne) — `21-communication-emails.md`
- Module 24 (Assistant IA — moteur de crédits partagé) — `24-communication-assistant-ia.md`
- Module 30 (Configuration — table `notifications` partagée, cloche du bandeau) — `30-configuration.md`
